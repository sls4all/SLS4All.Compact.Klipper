...
class ManualStepper:
    def __init__(self, config):
        ...
        gcode.register_mux_command('GET_MANUAL_STEPPER_POS', "STEPPER",
                                   self.stepper_name, self.cmd_GET_MANUAL_STEPPER_POS,
                                   desc=self.cmd_GET_MANUAL_STEPPER_POS_help)
    ...
    cmd_GET_MANUAL_STEPPER_POS_help = "Get position of manually configured stepper"
    def cmd_GET_MANUAL_STEPPER_POS(self, gcmd):
        pos = self.rail.get_commanded_position()
        msg = "%s:%d" % (self.stepper_name,pos,)
