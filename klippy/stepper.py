...
class MCU_stepper:
    def __init__(self, name, step_pin_params, dir_pin_params, step_dist,
        ...
        self._no_delay = name == "stepper_inova_x" or name == "stepper_inova_y"
        logging.info('Stepper:"%s", NoDelay=%d' % (name,self._no_delay,))
    ...
    def _build_config(self):
        ...
        self._mcu.add_config_cmd(
            ...
            " min_stop_interval=%d invert_step=%d no_delay=%d" % (
                self._oid, self._step_pin, self._dir_pin,
                self._mcu.seconds_to_clock(min_stop_interval),
                self._invert_step, self._no_delay))
